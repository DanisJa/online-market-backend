...
public class OrderService {
    ...
    private List<OrderDetailsDTO> toOrdersDetailsDTO(List<Order> orders) {
    ...
    OrderDetailsDTO orderDetails = new OrderDetailsDTO(order, customer, items);
    return orderDetails;
    }
